...
+ (id)plusButton
{
    ...
    UIImage *buttonImage = [UIImage imageNamed:@"m_center"];
    UIImage *highlightImage = [UIImage imageNamed:@"m_center"];
...
//    [actionSheet showInView:viewController.view];
    ...
    CenterPopView * alert = [[CenterPopView alloc]initWithAlertViewHeight:0];
...
//        UINavigationController *viewController = tabBarController.selectedViewController;
        ...
        switch (button.tag) {
            case 1:
//                [viewController pushViewController:[PostStatusViewController new] animated:YES];

                break;
            case 2:
//                [viewController pushViewController:[CreateClassViewController new] animated:YES];

                break;
            case 3:
//                [viewController pushViewController:[AddFriendViewController new] animated:YES];
...
//    [viewController pushViewController:[CYLDetailsViewController new] animated:YES];
