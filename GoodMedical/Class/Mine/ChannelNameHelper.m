...
@implementation ChannelNameHelper


+(instancetype)blog{
    
    return [[ChannelNameHelper alloc]init];
}
...
- (instancetype)init{
    ...
    if (self = [super init]) {
        ...
        self.rows = @[self.nameCell,self.adressCell,self.institutionsCell,self.departmentCell];
...
- (InputTableViewCell *)institutionsCell{
    ...
    if (!_institutionsCell) {
        ...
        _institutionsCell = [[InputTableViewCell alloc]initWithValue:@"" tip:@"请输入民族" title:@"民族"];
...
- (InputTableViewCell *)departmentCell{
    ...
    if (!_departmentCell) {
        ...
        _departmentCell = [[InputTableViewCell alloc]initWithValue:@"" tip:@"请输入联系地址" title:@"联系地址"];
