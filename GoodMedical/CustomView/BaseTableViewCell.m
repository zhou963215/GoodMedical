...
- (UIView *)fieldView {
    if(!_fieldView){
        _fieldView = [[UIView alloc] initWithFrame:CGRectMake((CGFloat) (WIDTH*0.4-30), 0, (CGFloat) (WIDTH*0.6), 28)];
        _fieldView.center = CGPointMake(_fieldView.center.x+10, 44/2);
//                _fieldView.backgroundColor = [UIColor redColor];
    }
    return _fieldView;
}
